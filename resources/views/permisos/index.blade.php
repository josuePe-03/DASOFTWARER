<x-app-layout>
    ...
    <div class="mb-4">
        <a href="{{ route('permisos.create') }}" class="bg-white/20 hover:bg-white/30 text-white px-4 py-2 rounded transition">
            + Nuevo permiso
        </a>
    </div>
                ...
                @foreach($permisos as $permiso)
                    <tr class="border-b border-white/20 hover:bg-white/10 transition">
                        ...
                        <td class="px-4 py-2 flex gap-2">
                            <a href="{{ route('permisos.edit', $permiso) }}" class="text-cyan-200 hover:text-white transition">Editar</a>
