        ...
        <form action="{{ route('perfiles.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="nombre" 
                       class="w-full rounded-lg bg-white/20 text-white px-3 py-2 focus:outline-none focus:ring-2 focus:ring-cyan-300 focus:border-cyan-300" required>
            </div>
            ...
            <div class="flex items-center space-x-4 mt-6">
                ...
                <a href="{{ route('perfiles.index') }}" class="text-white/70 hover:text-white hover:underline transition">Cancelar</a>
            </div>
        </form>
    </div>
</x-app-layout>
